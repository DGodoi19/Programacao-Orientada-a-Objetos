...
import negocio.Produto;
	...
	public class VisaoCompra extends JFrame{
		...
		private JTextField txtData = new JTextField("Data");
		
		private JLabel lblQuantidade= new JLabel ("Quantidade");
		private JTextField txtQuantidade = new JTextField("Quantidade");
		...
		private DefaultListModel<String> dlmCompra =
		...
		public VisaoCompra() {
			...
			add(btnExcluir);
			btnExcluir.addActionListener(new ControladorExcluir(lstCompra));
			...
			add(btnLimpar);
			btnLimpar.addActionListener(new ControladorLimpar(cboProduto,cboCliente, txtData, txtQuantidade, lstCompra));
			
			btnSair.setBounds(290, 210, 80, 30);
			add(btnSair);
			btnSair.addActionListener(new ControladorSair());
			
			jspCompra.setBounds(10,260,365,200);
			add(jspCompra);
