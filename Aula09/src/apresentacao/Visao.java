...
public class Visao extends JFrame {
	...
	private DefaultListModel<String> dlmListaDeOpcoes =
			new DefaultListModel<String>();
	private JScrollPane jspListaDeOpcoes =
			new JScrollPane(lstListaDeOpcoes);
