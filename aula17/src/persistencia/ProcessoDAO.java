...
public class ProcessoDAO {
	//propriedades da classe
		...
		public void persistir(Processo objProcesso) throws Exception{
			...
			objExecucao = objBanco.getObjConexao().prepareStatement("INSERT INTO PRC_PROCESSO" + 
		...
		public int getUltimoId() throws Exception{
			...
			objBanco.conectar();
			objExecucao = objBanco.getObjConexao().prepareStatement("SELECT MAX(PRC_ID) FROM PRC_PROCESSO");
