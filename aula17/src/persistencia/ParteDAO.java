...
public class ParteDAO {
	//propriedades da classe
		...
		public void persistir(Parte objParte) throws Exception{
			...
			objExecucao = objBanco.getObjConexao().prepareStatement("INSERT INTO PRT_PARTE" + 
		...
		public int getUltimoId() throws Exception{
			...
			objBanco.conectar();
			objExecucao = objBanco.getObjConexao().prepareStatement("SELECT MAX(PRT_ID) FROM PRT_PARTE");
