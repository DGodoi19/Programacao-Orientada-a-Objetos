...
public class VisaoProcesso extends JFrame {
	...
	lblVara.setBounds(10, 200, 200, 20);
	add(lblVara);
	txtVara.setBounds(10, 220, 100, 20);
	add(txtVara);
	
	
	lblCPF.setBounds(10, 160, 200, 20);
	add(lblCPF);
	txtCPF.setBounds(10, 180, 100, 20);
	add(txtCPF);
	...
	//Configuração da lista das partes
	jspPartes.setBounds(410, 200, 350, 150);
	add(jspPartes);
	lstPartes.setModel(dlmPartes);
	
	//Configurção dos Botões
	btnIncluir.setBounds(340, 250, 50, 20);
	add(btnIncluir);
